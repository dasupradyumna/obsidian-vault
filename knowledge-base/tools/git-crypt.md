...
- The encrypted AES key under `.git-crypt` is committed into the repo.
...
Run `git-crypt unlock <raw-aes>` to immediately decrypt the repo, without involving GPG at all.
**But this method is much more prone to security breach**